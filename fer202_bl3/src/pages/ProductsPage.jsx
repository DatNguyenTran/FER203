  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        showToast(
          "Failed to load products. Please check if the server is running.",
          "danger"
        );
        // Set some default products for demo
        setProducts([
          {
            id: 1,
            name: "iPhone 14",
            ...
            price: 399,
            description:
              "iPhone 14 smartphone with great performance and features.",
            category: "iphone",
          },
          {
            id: 2,
            ...
            price: 549,
            description:
              "Oppo Reno13 smartphone with great performance and features.",
            category: "oppo",
          },
        ]);
      } finally {
